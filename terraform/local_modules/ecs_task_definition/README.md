...
This is module will generate an ECS Task Definition. It's made up of a
sub-module called `container_definition` which will generate the JSON required
for the task definition anda allows you to pass in all necessary/allowed parameters for
Fargate based ECS tasks.
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_container_definition"></a> [container\_definition](#module\_container\_definition) | ./container_definition | n/a |
...
| [aws_iam_role_policy_attachment.ecs_service_ec2_role](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy_attachment) | resource |
...
|------|-------------|------|---------|:--------:|
| <a name="input_cloudwatch_logs_retention_in_days"></a> [cloudwatch\_logs\_retention\_in\_days](#input\_cloudwatch\_logs\_retention\_in\_days) | Number in days that CloudWatch will keep logs | `number` | `3` | no |
...
| <a name="input_enable_ecr_access"></a> [enable\_ecr\_access](#input\_enable\_ecr\_access) | Whether to attach the `AmazonEC2ContainerServiceforEC2Role` to the ECS Task Execution role | `bool` | `false` | no |
| <a name="input_enable_ecs_exec"></a> [enable\_ecs\_exec](#input\_enable\_ecs\_exec) | Whether to attach the SSM permissions to the ECS Task Execution role | `bool` | `false` | no |
...
| <a name="input_requires_compatibilities"></a> [requires\_compatibilities](#input\_requires\_compatibilities) | The list of compatibilities for the service | `list(string)` | <pre>[<br>  "FARGATE"<br>]</pre> | no |
...
| <a name="input_volume"></a> [volume](#input\_volume) | The volume for the service | `list(any)` | `[]` | no |
...
| <a name="output_log_configuration_awslogs_group"></a> [log\_configuration\_awslogs\_group](#output\_log\_configuration\_awslogs\_group) | Name of the AWS logs group in the log configuration if specified |
